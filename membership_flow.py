...
def setup_membership_handlers(client, user_states):
    ...
    async def membership_callback_handler(event):
        ...
        if data == "membership_confirm":
            ...
            try:
                await event.edit("👤 لطفاً نام و نام خانوادگی خود را ارسال کنید:", buttons=CANCEL_BUTTON)
            except:
                await event.reply("👤 لطفاً نام و نام خانوادگی خود را ارسال کنید:", buttons=CANCEL_BUTTON)
