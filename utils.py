...
def get_main_menu_buttons(is_admin=False):
    if is_admin:
        ...
        return [
            [Button.inline("📅 مدیریت رویدادها", b"admin_events"), Button.inline("⏳ ثبت‌نام‌های در انتظار", b"admin_pending_regs")],
            [Button.inline("👥 درخواست‌های عضویت", b"admin_membership_requests"), Button.inline("📤 ارسال همگانی", b"admin_broadcast")],
            [Button.inline("💡 ایده‌ها", b"admin_ideas"), Button.inline("🤝 همکاری‌ها", b"admin_collaborations")],
            [Button.inline("💰 حمایت‌ها", b"admin_donations"), Button.inline("🎟️ مدیریت تیکت‌ها", b"admin_tickets")],
            [Button.inline("🧏‍♂️ مدیریت ادمین‌ها", b"admin_manage_admins"), Button.inline("❓ مدیریت FAQ", b"admin_faq")],
            [Button.inline("🧹 نگهداری/پاکسازی", b"admin_maintenance"), Button.inline("📜 ارسال گواهی", b"admin_send_cert")],
            [Button.inline("📥 دریافت اکسل تاییدشدگان", b"admin_export_excel"), Button.inline("🎯 تنظیم ظرفیت رویداد", b"admin_capacity")],
            [Button.inline("⚙️ تنظیمات", b"admin_settings")],
            [Button.inline("🕘 تاریخچه ادمین", b"admin_actions_history"), Button.inline(f"🖥️ Console logs (English): {en_label}", b"toggle_console_logs")],
        ...
        flat.append(Button.inline("📬 ارسال تیکت", b"ask_ticket"))
        # new user actions: idea, collaboration, donation
